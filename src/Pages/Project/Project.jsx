    ...
    return (
        <Box id="project" padding={isNonMobile ? "6rem" : "1rem"} sx={{ fontFamily: "serif", color: "white" }} component={motion.div}
            ...
            <Box width="100%" display="flex" flexWrap="wrap" justifyContent="space-evenly" rowGap={4} px={!isNonMobile && "1rem"}>
                <ProjectCard Project_Pic={"../../assets/Portfolio.png"} Title={"Portfolio Website"}
                ...
                <ProjectCard Project_Pic={"../../assets/Github-user-finder.png"} Title={"Github-User-Finder"}
                ...
                <ProjectCard Project_Pic={"../../assets/Authentication.png"} Title={"Firebase Authentication"}
                ...
                <ProjectCard Project_Pic={"../../assets/Alumini.png"} Title={"Placement Helper"}
                ...
                <ProjectCard Project_Pic={"../../assets/Extension.png"} Title={"Chrome Extension"}
